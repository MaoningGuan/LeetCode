...
class Solution:
    ...
    def maxDepth_2(self, root: TreeNode, depth: int) -> int:
        """
        ...
        self.maxDepth_2(root.left, depth + 1)
        self.maxDepth_2(root.right, depth + 1)


    def maxDepth_3(self, root: TreeNode) -> int:
        """
...
if __name__ == '__main__':
    ...
    solution.maxDepth_2(root, 1)
    print(solution.depth)
    print(solution.maxDepth_3(root))
